                                        ...
                                        <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Status</th>
                                                    <th>Action
                                                        <form method="get" id="success"
                                                            action="{{ url('appointment.success') }}">
                                            ...
                                            <tbody>
                                                @foreach ($appointments as $appointment)
                                                    <tr>
                                                        ...
                                                        <td>@php
                                                            $patient = collect($patients)
                                                                ->where('out_p_id', $appointment->app_p_id)
                                                                ->first();
                                                        @endphp
                                                            {{ $patient->out_p_name }}
                                                        </td>
                                                        ...
                                                        <td>@php
                                                            $doctor = collect($doctors)
                                                                ->where('doc_id', $appointment->app_doc_id)
                                                                ->first();
                                                        @endphp
                                                            {{ $doctor->doc_name }}</td>
                                                            ...
                                                            @if ($appointment->app_status == 'Pending')
                                                                <div class="btn-group">
                                                                    ...
                                                                    <div class="dropdown-menu">
                                                                        <button class="dropdown-item" id="status"
                                                                            data="Approved"
                                                                            get_id="{{ $appointment->app_id }}">Approved</button>
                                                                        <button class="dropdown-item" id="status"
                                                                            data="Cancel"
                                                                            get_id="{{ $appointment->app_id }}">Cancel</button>
                                                                    </div>
                                                                </div>
                                                            @elseif($appointment->app_status == 'Approved')
                                                                <div class="btn-group">
                                                                    ...
                                                                    <div class="dropdown-menu">
                                                                        <button class="dropdown-item" id="status"
                                                                            data="Pending"
                                                                            get_id="{{ $appointment->app_id }}">Pending</button>
                                                                        <button class="dropdown-item" id="status"
                                                                            data="Cancel"
                                                                            get_id="{{ $appointment->app_id }}">Cancel</button>
                                                                    </div>
                                                        ...
                                                        <td>
                                                            <button class='show btn btn-outline-primary btn-sm'
                                                                data-toggle='modal' data-target='#showModal'
                                                                data="{{ $appointment->app_id }}"><i
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                        ...
                                        <div>
                                            <select class="form-control" id="app_p_id" name="app_p_id">
                                                ...
                                                @foreach ($patients as $patient)
                                                    <option value="{{ $patient->out_p_id }}">{{ $patient->out_p_name }}
                                                        ({{ $patient->out_p_s }})</option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group col-md-6">
                                        ...
                                        <div>
                                            <input type="text" readonly class="form-control" id="p_age"
                                                placeholder="Age" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div>
                                            <input class="form-control" readonly type="text" id="p_phone"
                                                placeholder="Phone" />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4" style="background: #f4f4f4;">
                                <div class="form-group col-md-12">
                                    ...
                                    <div>
                                        <input class="form-control" id="app_date" placeholder="Appointment Date"
                                            name="app_date" />
